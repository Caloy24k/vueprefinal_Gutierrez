<template>
    ...
    <div class="card bg-danger text-white drawer" :class="{show: active}">
        <button class="drawerClose btn bg-success btn-outline-light float-end mb-2" @click="$emit('closeProd')">
            X
        </button>
        ...
        <div v-if="product" class="pDetails">
            ...
            <div class="buttonCon mt-5">
                <button class="remove border border-outline-light btn btn-success btn-outline-light" @click="removetoCart()">Remove</button>
                <button class="add border border-outline-light btn btn-success btn-outline-light" @click="addToCart()">Add</button>
            </div>
        </div>
    </div>
</template>
